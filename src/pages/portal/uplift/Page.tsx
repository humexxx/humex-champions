        ...
        <Container maxWidth="lg">
          ...
          >
            <Box sx={{ position: 'relative', zIndex: 1 }}>
              ...
              >
                Build lasting habits, track meaningful progress, and achieve
                your personal development goals with our intelligent growth
                platform
              </Typography>
              <Box
                sx={{
          ...
          >
            <CardContent sx={{ p: 6, textAlign: 'center' }}>
              ...
              >
                Get detailed insights into your daily habits, weekly progress,
                and long-term growth trends with our comprehensive analytics
                dashboard
              </Typography>
              <Box
                sx={{
