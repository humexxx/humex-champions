      ...
      <PageHeader
        ...
        navigator={{
          breadcrumb: [
            {
              title: 'Progress Analytics',
              route: ROUTES.PORTAL.UPLIFT.ANALYTICS.split('/').pop()!,
            },
          ],
          link: { title: 'Uplift', route: ROUTES.PORTAL.UPLIFT.INDEX },
        }}
        description="Track your habits and achievements with detailed insights"
      />
      <PageContent>
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              Get insights into your daily habits, track your streaks, and
