import { GetAssetDetailsInput } from '@shared/schemas/finances';
import {
  GetAssetDetailsInput as GetAssetDetailsInputType,
  IAsset,
...
export const getAssetDetailsCallable = onCall<GetAssetDetailsInputType>(
